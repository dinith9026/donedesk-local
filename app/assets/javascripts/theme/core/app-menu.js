		...
		$.app.menu = {
			...
			changeLogo: function(menuType){
				...
				if(menuType == 'expand'){
					...
					logo.attr('width', logo.data('expand-width'));
					logo.attr('height', logo.data('expand-height'));
				}
				else{
					logo.attr('src',logo.data('collapse'));
					logo.attr('width', logo.data('collapse-width'));
					logo.attr('height', logo.data('collapse-height'));
				}
			},
