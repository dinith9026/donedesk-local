namespace :donedesk do
  namespace :oneoff do
    desc 'Enable send_compliance_summary_email setting for some'
    task enable_compliance_email_setting: :environment do
      ...
      account_ids.each do |account_id|
        ...
        account.users.each do |user|
          user.update!(send_compliance_summary_email: true)
          puts user.email
        end
      end
